...
function Toolbar({annoationCategories, selectedCategory, setSelectedCategory, creatingComponent, toggleAnnotationCategories, setCreatingComponent, setToggleAnnotationCategories}) {
